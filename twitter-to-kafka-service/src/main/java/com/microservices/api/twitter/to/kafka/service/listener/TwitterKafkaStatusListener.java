package com.microservices.api.twitter.to.kafka.service.listener;

import com.microservices.api.config.KafkaConfigData;
import com.microservices.api.kafka.avro.model.TwitterAvroModel;
import com.microservices.api.kafka.producer.config.service.KafkaProducer;
import com.microservices.api.twitter.to.kafka.service.transformer.TwitterStatusToAvroTransformer;
